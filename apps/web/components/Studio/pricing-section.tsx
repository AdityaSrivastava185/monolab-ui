...
export default function PricingSection() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2" style={{ 
      backgroundColor: "var(--section-bg, transparent)",
      color: "var(--section-text, inherit)"
    }}>
      {/* Header Section */}
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 flex justify-center items-center gap-6" style={{ borderBottom: "1px solid var(--section-border, rgba(55,50,47,0.12))" }}>
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          {/* Pricing Badge */}
          <div className="px-[14px] py-[6px] shadow-[0px_0px_0px_4px_rgba(55,50,47,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] shadow-xs" style={{ backgroundColor: "var(--section-bg, white)", borderColor: "var(--section-border, rgba(2,6,23,0.08))", border: "1px solid var(--section-border, rgba(2,6,23,0.08))" }}>
            <div className="w-[14px] h-[14px] relative overflow-hidden flex items-center justify-center">
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  stroke="var(--section-text, #37322F)"
                  strokeWidth="1"
                  strokeLinecap="round"
            ...
            <div className="text-center flex justify-center flex-col text-xs font-medium leading-3 font-sans" style={{ color: "var(--section-text, #37322F)" }}>
              Plans & Pricing
            </div>
          </div>

          {/* Title */}
          <div className="self-stretch text-center flex justify-center flex-col text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight" style={{ color: "var(--section-text, #49423D)" }}>
            Choose the perfect plan for your business
          </div>

          {/* Description */}
          <div className="self-stretch text-center text-base font-normal leading-7 font-sans" style={{ color: "var(--section-text, #605A57)" }}>
