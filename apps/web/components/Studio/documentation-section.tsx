...
export default function DocumentationSection() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center" style={{ 
      ...
      borderBottom: "1px solid var(--section-border, rgba(55,50,47,0.12))"
    }}>
      {/* Header Section */}
            ...
            {cards.map((card, index) => {
              ...
              return (
                <div
                  ...
                  style={{
                    backgroundColor: isActive ? "var(--section-bg, white)" : "transparent",
                    border: isActive ? "none" : "1px solid var(--section-border, rgba(2,6,23,0.08))"
                  }}
                >
                  <div
                  ...
                  <div className="px-6 py-5 w-full flex flex-col gap-2">
                    <div className="self-stretch flex justify-center flex-col text-sm font-semibold leading-6 font-sans" style={{ color: "var(--section-text, #49423D)" }}>
                      {card.title}
                    </div>
                    <div className="self-stretch text-[13px] font-normal leading-[22px] font-sans whitespace-pre-line" style={{ color: "var(--section-text, #605A57)" }}>
                      {card.description}
                    </div>
                  </div>
                </div>
